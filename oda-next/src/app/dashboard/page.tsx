    ...
    <ProtectedRoute>
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-30 flex items-center gap-4 border-b border-white/10 bg-[#0a0a0a]/85 backdrop-blur-md px-4 sm:px-6 py-4">
          ...
          <Link
            href="/designer"
            className="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-[#8F5F4A] hover:bg-[#A26E57] text-[#F5EFE7] text-sm font-bold rounded-xl shadow-lg shadow-[#8F5F4A]/25 border border-[#C9A66B]/30 hover:scale-[1.02] transition-all active:scale-98"
          >
        ...
        <main className="px-4 sm:px-6 py-6 max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3.5">
              <Link
                href="/designer"
                className="flex items-center justify-center gap-2 px-6 py-3.5 bg-[#8F5F4A] hover:bg-[#A26E57] text-[#F5EFE7] text-sm font-bold rounded-xl shadow-lg shadow-[#8F5F4A]/25 border border-[#C9A66B]/30 hover:scale-[1.01] transition-all"
              >
              ...
              <Link
                href="/furniture"
                className="flex items-center justify-center gap-2 px-6 py-3.5 bg-[#37241A] border border-[#D8C3A5]/20 text-[#D8C3A5] text-sm font-semibold rounded-xl hover:bg-[#8F5F4A]/25 transition-colors"
              >
                <Sofa className="h-4 w-4 text-[#C9A66B]" />
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-bold text-[#F5EFE7] flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-[#C9A66B]" />
                  Recent AI Designs
                </h2>
                <Link
                  href="/dashboard/projects"
                  className="text-xs sm:text-sm text-[#C9A66B] hover:text-[#D8C3A5] font-semibold flex items-center gap-1"
                >
                  View All Projects
              ...
              {recentDesigns.length === 0 ? (
                <div className="bg-[#22150E] rounded-2xl border border-[#D8C3A5]/20 p-12 text-center">
                  <div className="h-14 w-14 rounded-2xl bg-[#8F5F4A]/20 border border-[#C9A66B]/30 flex items-center justify-center mx-auto mb-4">
                    <Wand2 className="h-7 w-7 text-[#C9A66B]" />
                  </div>
                  <p className="text-[#F5EFE7] font-bold mb-1">
                    No designs yet
                  </p>
                  <p className="text-sm text-[#CDBFB2] mb-5 max-w-sm mx-auto">
                    Upload a room photo and let Insight Nexsus AI create tailored photorealistic designs for you.
                  </p>
                  <Link
                    href="/designer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#8F5F4A] hover:bg-[#A26E57] text-[#F5EFE7] text-sm font-bold rounded-xl shadow-lg shadow-[#8F5F4A]/25 border border-[#C9A66B]/30 hover:scale-[1.02] transition-transform"
                  >
                    <Wand2 className="h-4 w-4 stroke-[2.5]" />
                    Start Designing
                  </Link>
