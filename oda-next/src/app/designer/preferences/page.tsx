...
const moods = [
  ...
  { id: 'calm', label: 'Calm', color: 'from-blue-50 to-indigo-50', accent: 'bg-blue-100 text-blue-700' },
  { id: 'elegant', label: 'Elegant', color: 'from-purple-50 to-pink-50', accent: 'bg-purple-100 text-purple-700' },
  { id: 'bold', label: 'Bold', color: 'from-red-50 to-orange-50', accent: 'bg-red-100 text-red-700' },
  { id: 'natural', label: 'Natural', color: 'from-green-50 to-emerald-50', accent: 'bg-green-100 text-green-700' },
];

const colors = [
  { id: 'light', label: 'Light', gradient: 'from-gray-50 to-white', ring: 'ring-gray-200' },
  { id: 'dark', label: 'Dark', gradient: 'from-gray-800 to-gray-900', ring: 'ring-gray-700' },
  { id: 'neutral', label: 'Neutral', gradient: 'from-stone-100 to-stone-50', ring: 'ring-stone-300' },
  { id: 'warm', label: 'Warm', gradient: 'from-amber-100 to-orange-50', ring: 'ring-amber-300' },
  { id: 'cool', label: 'Cool', gradient: 'from-blue-100 to-cyan-50', ring: 'ring-blue-300' },
  { id: 'ai', label: 'Let AI Choose', gradient: 'from-purple-100 to-pink-50', ring: 'ring-purple-300' },
];

const budgets = [
  { id: 50000, label: '₹50,000', desc: 'Essential refresh' },
  { id: 100000, label: '₹1 Lakh', desc: 'Moderate update' },
  { id: 200000, label: '₹2 Lakh', desc: 'Significant upgrade' },
  { id: 500000, label: '₹5 Lakh', desc: 'Complete makeover' },
  { id: 1000000, label: '₹10 Lakh', desc: 'Premium transformation' },
];
...
export default function PreferencesPage() {
  ...
  const sections = ['style', 'mood', 'color', 'budget'];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Design Preferences</h1>
          <p className="text-sm text-gray-500">Tell us about your style to generate perfect designs</p>
        </div>
                ...
                >
                  {moods.map((mood) => (
                    ...
                    >
                      ...
                      <div className={`w-full h-16 rounded-lg bg-gradient-to-br ${mood.color} mb-3`} />
                      <span className={`inline-block px-2 py-0.5 rounded text-[11px] font-medium ${mood.accent}`}>
                        {mood.label}
                      </span>
                    </button>
                  ))}
                ...
                >
                  {colors.map((color) => (
                    ...
                    >
                      ...
                      <div
                        className={`w-full h-20 rounded-lg bg-gradient-to-br ${color.gradient} ring-2 ${color.ring} mb-3`}
                      />
                      <h3 className="text-sm font-medium text-gray-900">{color.label}</h3>
                    </button>
                  ))}
                </motion.div>
              )}
              ...
              {currentSection === 3 && (
                ...
                >
                  {budgets.map((budget) => (
                    ...
                    >
                      <div>
                        <h3 className="text-base font-semibold text-gray-900">{budget.label}</h3>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <h3 className="text-base font-semibold text-gray-900">Custom Budget</h3>
                      <div
                        className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
          ...
          <div className="p-6 border-t border-gray-100 flex gap-3">
            ...
            {currentSection < sections.length - 1 ? (
              ...
              <button
                ...
                className="flex-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white py-3 rounded-lg font-semibold text-sm hover:from-amber-600 hover:to-orange-600 transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-200"
              >
